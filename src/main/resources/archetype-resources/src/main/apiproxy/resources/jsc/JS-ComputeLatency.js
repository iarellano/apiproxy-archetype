...
context.setVariable("message.statistics.clientLatency", total_client_time);
context.setVariable("message.statistics.targetLatency", total_target_time);
context.setVariable("message.statistics.totalLatency", total_request_time);